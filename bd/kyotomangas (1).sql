...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 30-Nov-2022 às 12:41
...
--
CREATE DATABASE IF NOT EXISTS `kyotomangas` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `kyotomangas`;
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  `id-matricula` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `funcionarios` (`id-matricula`, `ID`, `Senha`) VALUES
(2, '1234', '1234');
...
INSERT INTO `produtos` (`codigo_produto`, `titulo`, `serie`, `genero`, `autor`, `editora`, `volume`, `sinopse`, `capa`) VALUES
